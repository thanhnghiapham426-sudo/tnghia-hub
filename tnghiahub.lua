loadstring([[ 
-- tnghia hub v4.1 - Có nút bật/tắt Menu
...
logo.Image = "rbxassetid://16597012603"
logo.ImageColor3 = Color3.fromRGB(0, 255, 220)
...
toggleBtn.MouseButton1Click:Connect(function()
    ...
    toggleBtn.BackgroundColor3 = menuVisible and Color3.fromRGB(0, 120, 255) or Color3.fromRGB(100, 100, 100)
end)
...
bHide.MouseButton1Click:Connect(function()
    ...
    for _,v in workspace:GetDescendants() do
        pcall(function()
            if v:IsA("BasePart") or v:IsA("MeshPart") then v.Transparency = hide and 1 or 0 end
        end)
    end
end)
...
task.spawn(function()
    local i=1
    while true do
        fps.TextColor3 = Color3.fromRGB(colors[i],colors[i+1],colors[i+2])
        i = (i+2)%#colors +1
        task.wait(0.17)
    end
end)
...
game.StarterGui:SetCore("SendNotification", {
    Title = "tnghia hub v4.1";
    Text = "Đã thêm nút bật/tắt Menu!\nNhấn icon 🔧 để ẩn/hiện.";
    Duration = 7;
})

print("✅ tnghia hub v4.1 Loaded! | " .. p.Name)
]])()
